 ...
 * @author mabrams
 */
public abstract class AbstractLaunchConfigurationDelegate extends
    AbstractJavaLaunchConfigurationDelegate implements
    ICougaarLaunchConfigurationDelegate {
  ...
  public void launch(ILaunchConfiguration configuration, String mode,
    ...
    if (runner == null) {
      if (mode == ILaunchManager.DEBUG_MODE) {
        ...
        abort(
            MessageFormat
                .format(
                    LaunchingMessages.JavaLocalApplicationLaunchConfigurationDelegate_0,
                    new String[] { vm.getName()}), null,
            IJavaLaunchConfigurationConstants.ERR_VM_RUNNER_DOES_NOT_EXIST); //$NON-NLS-1$
      }
    }
    ...
    monitor
        .subTask(LaunchingMessages.JavaLocalApplicationLaunchConfigurationDelegate_Creating_source_locator____2); //$NON-NLS-1$
  ...
  /**
   * Returns the program arguments specified by the given launch configuration,
   * as a string. The returned string is empty if no program arguments are
   * specified.
   * 
   * @param configuration
   *          launch configuration
   * 
   * @return the program arguments specified by the given launch configuration,
  ...
  public String getVMArguments(ILaunchConfiguration configuration)
    ...
    String ret = "";
    Map vmParameters = configuration.getAttribute(

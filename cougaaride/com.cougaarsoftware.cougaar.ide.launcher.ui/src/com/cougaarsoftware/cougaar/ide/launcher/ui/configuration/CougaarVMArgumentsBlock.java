...
public class CougaarVMArgumentsBlock extends VMArgumentsBlock {
  ...
  public void performApply(ILaunchConfigurationWorkingCopy configuration,
    ...
    if (useDefault) {
      ...
      configuration.setAttribute(
          IJavaLaunchConfigurationConstants.ATTR_VM_ARGUMENTS, fVMArgumentsText
              .getText());
    }
  }
  ...
  public void createControl(Composite parent) {
    ...
    fVMArgumentsLabel
        .setText(LauncherMessages.JavaArgumentsTab_VM_ar_guments__6);
    fVMArgumentsLabel.setFont(font);

    fVMArgumentsText = new Text(comp, SWT.MULTI | SWT.WRAP | SWT.BORDER
        | SWT.V_SCROLL);
  ...
  private String createCougaarVMArgs(ILaunchConfigurationWorkingCopy config)
    ...
    String cougaarHome = config.getAttribute(
        ICougaarConstants.ATTR_COUGAAR_HOME_DIR, "");
    String cougaarVMArgs = ICougaarConstants.COUGAAR_INSTALL_PATH + cougaarHome
        + " ";

    cougaarVMArgs += (ICougaarConstants.COUGAAR_CONFIG_PATH + ".;"
        + cougaarHome + "/common/configs;" + cougaarHome + "/configs/glmtrans ");
    cougaarVMArgs += (ICougaarConstants.COUGAAR_LOGGING_CONFIG + "log.properties ");

    cougaarVMArgs += (ICougaarConstants.COUGAAR_SYSTEM_PATH
        + config.getAttribute(ICougaarConstants.COUGAAR_SYSTEM_PATH, "") + "/sys ");
    cougaarVMArgs += (ICougaarConstants.COUGAAR_CORE_SERVLET_ENABLE + "true ");

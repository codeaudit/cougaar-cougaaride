 ...
 * @author Matt Abrams
 */
public class CougaarConfigurationBlock extends PropertyPage implements
    IAddCougaarDialogRequestor, ICougaarInstallChangeListener {
  ...
  public Control createContents(Composite parent) {
    ...
    fAddCougaarInstall.setText(CougaarPreferencesMessages
        .getString("CougaarConfigurationBlock.addCougaarInstallButton"));
  ...
  private IStatus updateCIPStatus(String cipVersion) {
    ...
    status.setWarning("Error Setting Cougaar Install Path Setting"); //$NON-NLS-1$
    return status;
  }

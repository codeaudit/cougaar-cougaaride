 ...
 * @author soster
 */
public class CougaarInstallSelectionWidget extends Composite implements
  ...
  public CougaarInstallSelectionWidget(Composite parent, int style,
    ...
    fAddCougaarInstall.setText(CougaarUIMessages
        .getString("CougaarCapabilityConfigurationPage.newInstallButton"));
